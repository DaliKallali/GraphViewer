...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @generated
	 */
	private EClass graphObjectEClass = null;
	 ...
	 * @see de.iils.dc43.graph.GraphPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EClass getGraphObject() {
		return graphObjectEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getGraphObject_Id() {
		return (EAttribute)graphObjectEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		graphObjectEClass = createEClass(GRAPH_OBJECT);
		createEAttribute(graphObjectEClass, GRAPH_OBJECT__ID);
	...
	public void initializePackageContents() {
		...
		nodeEClass.getESuperTypes().add(this.getPosition());
		nodeEClass.getESuperTypes().add(this.getGraphObject());
		edgeEClass.getESuperTypes().add(this.getGraphObject());
		...
		initEClass(graphObjectEClass, GraphObject.class, "GraphObject", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getGraphObject_Id(), ecorePackage.getEString(), "id", null, 1, 1, GraphObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

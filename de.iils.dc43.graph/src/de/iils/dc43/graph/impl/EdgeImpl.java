/**
 */
package de.iils.dc43.graph.impl;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.iils.dc43.graph.impl.EdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link de.iils.dc43.graph.impl.EdgeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EdgeImpl extends GraphObjectImpl implements Edge {
	/**
	...
	public void setSource(Node newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, GraphPackage.NODE__OUT, Node.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, GraphPackage.NODE__OUT, Node.class, msgs);
	...
	public void setTarget(Node newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, GraphPackage.NODE__IN, Node.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, GraphPackage.NODE__IN, Node.class, msgs);
